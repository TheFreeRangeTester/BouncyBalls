...
## Power-up de veneno: al recogerlo la bola entra en estado "poison active".
## Si choca con un enemigo de mayor poder, le aplica veneno (sin recibir daño) y consume el estado.

signal poison_collected
